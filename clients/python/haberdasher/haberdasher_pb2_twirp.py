...
class HaberdasherClient(object):
    ...
    def __init__(self, server_address):
        ...
        self.__service_name = "twirp.example.haberdasher.Haberdasher"
    ...
    def make_hat(self, size):
        ...
        serialize = _sym_db.GetSymbol("twirp.example.haberdasher.Size").SerializeToString
        deserialize = _sym_db.GetSymbol("twirp.example.haberdasher.Hat").FromString
    ...
    def get_bill(self, hat):
        """
        Get paid
        """

        serialize = _sym_db.GetSymbol("twirp.example.haberdasher.Hat").SerializeToString
        deserialize = _sym_db.GetSymbol("twirp.example.haberdasher.Bill").FromString

        full_method = "/{}/{}".format(self.__service_name, "GetBill")
        body = serialize(hat)
        resp_str = self.__make_request(body=body, full_method=full_method)
        return deserialize(resp_str)
...
class HealthClient(object):
    ...
    def __init__(self, server_address):
        """Creates a new client for the Health service.
        ...
        if sys.version_info[0] > 2:
            ...
            self.__target = server_address.encode('ascii')
        self.__service_name = "twirp.example.haberdasher.Health"
    ...
    def check(self, ping):
        serialize = _sym_db.GetSymbol("twirp.example.haberdasher.Ping").SerializeToString
        deserialize = _sym_db.GetSymbol("twirp.example.haberdasher.Pong").FromString

        full_method = "/{}/{}".format(self.__service_name, "Check")
        body = serialize(ping)
        resp_str = self.__make_request(body=body, full_method=full_method)
        return deserialize(resp_str)
